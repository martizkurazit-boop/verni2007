...
/* ── Статья ──────────────────────────────────────────────────────── */
/* Текст блока → отдельные абзацы. Абзац отделяет пустая строка. Одиночный
   перенос — это жёсткая вёрстка исходного документа (строка кончилась на
   семидесятом знаке), а не новая мысль: такие переносы сшиваются обратно
   пробелом. Иначе статья рассыпается на обрывки по половине предложения. */
